...
const BottomNavCard: React.FC<BottomNav> = ({
  ...
  return (
    <div className="bottom-nav lg:-pl-9 fixed bottom-0 right-0 flex h-[4.5rem] items-center justify-between border-t border-t-[#acafbe] bg-[#fff] px-4 max-md:left-0 lg:justify-around lg:border-none">
      <div>
        <button
